# ميسور (MAYSOOR) — منصة إدارة المتاجر والقنوات والذكاء الاصطناعي

**خدمة العملاء الذكية** · [maysoor.com](https://maysoor.com)
...
frontend/      React + TypeScript + Vite، بنظام تصميم ميسور
...
- **[docs/03-design-system.md](docs/03-design-system.md)** — نظام تصميم أصلي
  ("ميسور"): الألوان، الطباعة، المسافات، مواصفات المكوّنات، الحركة، وإمكانية
  الوصول (WCAG AA).
...
- **[docs/12-ux-ui-benchmark-and-proposal.md](docs/12-ux-ui-benchmark-and-proposal.md)**
  — مقارنة تجربة المستخدم ومقترح تحسين مبني على نظام تصميم ميسور.
...
- **[docs/19-simulation-links.md](docs/19-simulation-links.md)** — روابط
  دردشة قابلة للمشاركة تُحاكي واتساب بصريًا، تشغّل نفس محرك الذكاء
  الاصطناعي الحي، بلا حاجة لربط رقم واتساب حقيقي.
- **[docs/32-brand.md](docs/32-brand.md)** — الهوية البصرية: اللوحة اللونية
  ودور كل لون، **قاعدة التباين الحاكمة للبرتقالي** (ولماذا نص الأزرار
  كحلي لا أبيض)، الخطوط ولماذا هي مستضافة ذاتيًا، الشعار، وأين تعيش
  رموز التصميم — إضافةً إلى قائمة المعرّفات التقنية التي احتفظت باسم
  أطلس عمدًا ولماذا تغييرها يكسر الإنتاج.
